...
Adjust the application-*.yml files for each environment for your SAML SP and IdP configurations, and Twilio settings
...
To optimize the callme application for production, run:
